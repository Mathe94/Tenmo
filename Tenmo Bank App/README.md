...
### Primary use cases -- required

You must attempt to complete all of the following required use cases.
...
4. As an authenticated user of the system, I need to be able to *send* a transfer of a specific amount of TE Bucks to a registered user.
   ...
   4. A Sending Transfer has an initial status of *Approved*.
...
### Secondary use cases -- strongly recommended if you have time

If you complete all of the required use cases and have time remaining, you should complete as many of the following use cases as you can.
...
7. As an authenticated user of the system, I need to be able to *request* a transfer of a specific amount of TE Bucks from another registered user.
   ...
   6. I must not be allowed to request money from myself.
   7. I can't request a zero or negative amount.
